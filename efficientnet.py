...
class BaseModel(nn.Module):
    def __init__(self, nclass, aux=False, backbone='efficientnet_b0', pretrained_base=True, **kwargs):
    ...
    def base_forward(self, x):
        ...
        if self.backbone in ['efficientnet']:
...
class EfficientNetSeg(BaseModel):
    def __init__(self, nclass, aux=False, backbone='efficientnet', pretrained_base=True, **kwargs):
...
def get_efficientnet_seg(dataset='FetalBrainDataset', pretrained=False, root='~/.torch/models',
    ...
    acronyms = {
        ...
        'ade20k': 'ade',
        'coco': 'coco',
        'FetalBrainDataset': 'FetalBrainDataset',
    }

    model = EfficientNetSeg(dataset[dataset].NUM_CLASS, backbone='efficientnet',
